...
function EventFav({navigation}) {
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <View style={{ alignItems: 'center' }}>
                <Icon name="calendar" size={150} color='#CB8E97'></Icon>
                <Text style={{ fontWeight: 'bold', fontSize: '20px', width: '200px', textAlign: 'center', marginBottom: '20px' }}>You’re not tracking any Events</Text>
